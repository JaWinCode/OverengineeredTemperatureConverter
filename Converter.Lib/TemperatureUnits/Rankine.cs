...
{
    internal class Rankine : ConverterUnit
    {
        ...
        public static explicit operator Rankine(Kelvin inputValue) => new (inputValue.Value * 9 / 5);
        public static explicit operator Rankine(Fahrenheit inputValue) => new (inputValue.Value + 459.67m);
        public static explicit operator Rankine(Reaumur inputValue) => new ((inputValue.Value * 9 / 4) + 491.67m);
    }
}
